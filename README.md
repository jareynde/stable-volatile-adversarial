**Model_recov_HaS1sta_APmodels_all.py** --> model recovery of 4 models (eps-lr, eps-lr-uc, eps-2lr, eps-2lr-uc) in a stable context according to Hide and Seek experiment 1
